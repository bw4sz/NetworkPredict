predy<-trajF(alpha=-1.45,beta1=-0.056,trait=indat$Traitmatch,resources=scale(indat$FlowerA),beta2=0.22,beta3=-0.01)
predy2<-trajF(alpha=-1.45,beta1=-0.056,trait=indat$Traitmatch,resources=scale(indat$FlowerA),beta2=0.22,beta3=-.1)
