...
instance_id=$(aws ec2 run-instances --image-id ami-63935d03 --security-group-ids sg-890a37ed --count 1 --instance-type t2.medium --key-name rstudio --instance-initiated-shutdown-behavior stop --query 'Instances[0].{d:InstanceId}' --output text)
