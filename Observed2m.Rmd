...
flower.month$R<-cut(flower.month$Flowers,breaks=c(0,quantile(flower.month$Flowers,0.25),quantile(flower.month$Flowers,0.75),max(flower.month$Flowers)),label=c("Low","Medium","High"))
...
sflowers$R<-cut(sflowers$Flowers,breaks=c(0,quantile(sflowers$Flowers,0.25),quantile(sflowers$Flowers,0.75),max(sflowers$Flowers)),label=c("Low","Medium","High"))
