...
#MCMC options
  ...
  system.time(m2<-jags.parallel(data=Dat,InitStage,ParsStage,model.file="Bayesian/NmixturePoissonRagged2m.jags",n.thin=5,n.iter=500,n.burnin=500*.9,n.chains=2))
```
