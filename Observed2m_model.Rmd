...
#Jags Data
  ...
  #MCMC options
  system.time(m2<-jags.model(n.adapt=0,data=datlist,inits=InitStage,file="Bayesian/NmixturePoissonRagged2m.jags"))

    #system.time(m2<-jags(data=Dat,parameters.to.save =ParsStage,inits=InitStage,model.file="Bayesian/NmixturePoissonRagged2m.jags",n.thin=1,n.iter=100,n.burnin=0,n.chains=1,DIC=F))
```
